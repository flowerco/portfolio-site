...
export function SmartModel(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/models/SmartModel.glb");
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group ref={props.innerRef} name="Scene">
        <group name="Armature001" position={[0.9, -0.19, -4.13]} scale={4.5}>
...
useGLTF.preload("/models/SmartModel.glb");